  ...
  renderChildren() {
    ...
    return <ObjectContext.Consumer>
      ...
      {objectContext => {
         ...
         */
        const currentUserTechnology = currentUserId ? UserTechnologies.find(n => n.CreatedBy && n.CreatedBy.id === currentUserId) : null

        return currentUserTechnology ? null : <Button
          size="small"
          color="primary"
          variant="raised"
          disabled={loading}
            ...
            this.mutate({
              mutation: gql`
                mutation createUserTechnologyProcessor (
                  ...
                  response: createUserTechnologyProcessor (
                    data: $data
                  ){
                    success
                    message
